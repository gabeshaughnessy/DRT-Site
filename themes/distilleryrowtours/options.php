...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Site-Wide Settings', 'options_check'),
		'type' => 'heading');
	
	$options[] = array(
		'name' => __('Default Background Image', 'options_check'),
		'desc' => __('Select an image to use as the default background.', 'options_check'),
		'id' => 'default_bg',
		'type' => 'upload');
	
	/*$options[] = array(
		'name' => "Default Background Image",
		'desc' => "Select an image to use as the default background.",
		'id' => "default_bg",
		'std' => "image-1",
		'type' => "images",
		'options' => array(
			'image-1' => $imagepath . 'bg1_sm.jpg',
			'image-2' => $imagepath . 'bg2_sm.jpg',
			'image-3' => $imagepath . 'bg3_sm.jpg')
	);*/
