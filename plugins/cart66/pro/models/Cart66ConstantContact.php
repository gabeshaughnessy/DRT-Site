...
class Cart66ConstantContact {
	 ...
	 * @access 	public
	 */
	function __construct($api_username='', $api_password='', $api_key = '')
	{
	  if(empty($api_username)) {
	    $api_username = Cart66Setting::getValue('constantcontact_username');
	  }
	  
	  if(empty($api_password)) {
	    $api_password = Cart66Setting::getValue('constantcontact_password');
	  }
	...
	function get_all_lists($action = 'lists', $exclude = 3, $callback = '')
	{
		...
		if(count($lists) > 0):
			...
			$callback = ($callback) ? $callback : array("Cart66ConstantContact", "sort_lists");
			if(is_array($lists)):
...
';
		...
		Cart66Common::log('[' . basename(__FILE__) . ' - line ' . __LINE__ . "] Constant Contact update contact xml: $xml_data");
